            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!pLevel.isClientSide) {
                        ...
                        if (j > 0) {
                            abstractarrow.setBaseDamage(abstractarrow.getBaseDamage() + 1.2D + (double)j * 0.5D + 0.5D);
                        }
                    ...
                    pLevel.playSound((Player)null, player.getX(), player.getY(), player.getZ(), SoundEvents.ARROW_SHOOT, SoundSource.PLAYERS, 1.0F, 0.5F / (pLevel.getRandom().nextFloat() * 0.4F + 1.2F) + f * 0.5F);
